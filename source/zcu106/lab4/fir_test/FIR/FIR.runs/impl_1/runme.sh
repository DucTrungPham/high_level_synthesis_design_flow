...
HD_PWD='/home/userdata/k64D/trungpd_64d/vivado_work/test/srctest/source/zcu106/lab4_test/fir_test/FIR/FIR.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_audio_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_audio_wrapper.tcl -notrace
