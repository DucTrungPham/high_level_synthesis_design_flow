...
HD_PWD='/home/userdata/k64D/trungpd_64d/vivado_work/test/srctest/source/zcu106/lab4_test/fir_test/FIR/FIR.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_audio_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_audio_wrapper.tcl
