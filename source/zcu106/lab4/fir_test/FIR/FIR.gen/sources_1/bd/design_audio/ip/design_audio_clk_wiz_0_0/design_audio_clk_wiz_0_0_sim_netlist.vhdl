...
--               /home/userdata/k64D/trungpd_64d/vivado_work/test/srctest/source/zcu106/lab4_test/fir_test/FIR/FIR.gen/sources_1/bd/design_audio/ip/design_audio_clk_wiz_0_0/design_audio_clk_wiz_0_0_sim_netlist.vhdl
...
entity design_audio_clk_wiz_0_0_clk_wiz is
  port (
...
end design_audio_clk_wiz_0_0_clk_wiz;

architecture STRUCTURE of design_audio_clk_wiz_0_0_clk_wiz is
  signal clk_in1_design_audio_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out1_design_audio_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out2_design_audio_clk_wiz_0_0 : STD_LOGIC;
...
clkin1_ibuf: unisim.vcomponents.IBUF
    generic map(
      IOSTANDARD => "DEFAULT"
        ...
        port map (
      I => clk_in1,
      O => clk_in1_design_audio_clk_wiz_0_0
    );
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out1_design_audio_clk_wiz_0_0,
      O => clk_out1
    );
clkout2_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out2_design_audio_clk_wiz_0_0,
      O => clk_out2
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      BANDWIDTH => "OPTIMIZED",
      CLKFBOUT_MULT_F => 93.625000,
      CLKFBOUT_PHASE => 0.000000,
      CLKFBOUT_USE_FINE_PS => "FALSE",
      CLKIN1_PERIOD => 10.001000,
      CLKIN2_PERIOD => 0.000000,
      CLKOUT0_DIVIDE_F => 32.500000,
      ...
      CLKIN1 => clk_in1_design_audio_clk_wiz_0_0,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcme4_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => clk_out1_design_audio_clk_wiz_0_0,
      CLKOUT0B => NLW_mmcme4_adv_inst_CLKOUT0B_UNCONNECTED,
      CLKOUT1 => clk_out2_design_audio_clk_wiz_0_0,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_audio_clk_wiz_0_0 is
  port (
    clk_out1 : out STD_LOGIC;
    clk_out2 : out STD_LOGIC;
    reset : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of design_audio_clk_wiz_0_0 : entity is true;
end design_audio_clk_wiz_0_0;

architecture STRUCTURE of design_audio_clk_wiz_0_0 is
begin
inst: entity work.design_audio_clk_wiz_0_0_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      clk_out2 => clk_out2,
