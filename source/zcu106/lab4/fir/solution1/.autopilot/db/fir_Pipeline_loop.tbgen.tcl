...
set portList { 
	...
	{ acc_01_out sc_out sc_lv 31 signal 1 } 
	{ acc_01_out_ap_vld sc_out sc_logic 1 outvld 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "acc_01_out", "direction": "out", "datatype": "sc_lv", "bitwidth":31, "type": "signal", "bundle":{"name": "acc_01_out", "role": "default" }} , 
 	{ "name": "acc_01_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "acc_01_out", "role": "ap_vld" }} , 
...
set Spec2ImplPortList { 
	...
	acc_01_out { ap_vld {  { acc_01_out out_data 1 31 }  { acc_01_out_ap_vld out_vld 1 1 } } }
	shift_reg { ap_memory {  { shift_reg_address0 mem_address 1 6 }  { shift_reg_ce0 mem_ce 1 1 }  { shift_reg_we0 mem_we 1 1 }  { shift_reg_d0 mem_din 1 16 }  { shift_reg_address1 MemPortADDR2 1 6 }  { shift_reg_ce1 MemPortCE2 1 1 }  { shift_reg_q1 in_data 0 16 } } }
}
