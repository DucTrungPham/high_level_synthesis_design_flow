set SynModuleInfo {
  {SRCNAME fir_Pipeline_loop MODELNAME fir_Pipeline_loop RTLNAME fir_fir_Pipeline_loop
    SUBMODULES {
      {MODELNAME fir_mac_muladd_16s_16s_37s_37_4_1 RTLNAME fir_mac_muladd_16s_16s_37s_37_4_1 BINDTYPE op TYPE add IMPL dsp LATENCY 3 ALLOW_PRAGMA 1}
  ...
  {SRCNAME fir MODELNAME fir RTLNAME fir IS_TOP 1
    SUBMODULES {
      {MODELNAME fir_mul_mul_16s_10s_25_4_1 RTLNAME fir_mul_mul_16s_10s_25_4_1 BINDTYPE op TYPE add IMPL dsp LATENCY 3 ALLOW_PRAGMA 1}
      {MODELNAME fir_mac_muladd_16s_10s_31s_31_4_1 RTLNAME fir_mac_muladd_16s_10s_31s_31_4_1 BINDTYPE op TYPE add IMPL dsp LATENCY 3 ALLOW_PRAGMA 1}
